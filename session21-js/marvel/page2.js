var idCharacter = localStorage.getItem('idCharacter');
...
function run(data) {
    ...
    var imgScr = data.thumbnail.path + "." + data.thumbnail.extension;
    var name = data.name;
    var des = data.description;
    var comics = data.stories.items;
...
function fetchCharacters() {
    ...
    var fullUrl = `${url}?${key}&id=${idCharacter}`;
    console.log(fullUrl);
